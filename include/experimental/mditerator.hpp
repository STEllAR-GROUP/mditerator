...
private:
    ...
    constexpr mditerator(mdspan_type& span, iterpos) noexcept
      : span_(nullptr), idx_(span.extent(0))
    {}
...
constexpr mditerator<MdSpan> mditerator_end(MdSpan& span) noexcept
{
    return mditerator<MdSpan>(span, mditerator<MdSpan>::iterpos::end);
}
